# Basic Steam Stats
This is a project I made for fun to learn Django and to use the [Steam Web API](https://developer.valvesoftware.com/wiki/Steam_Web_API).

I store any games pulled from peoples libraries in a SQLite database as it took some time to pull the data from the web each time someone looked up their SteamID.
